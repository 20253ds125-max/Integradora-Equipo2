...
const defaultVenues = [
  { id: 1, name: "The Obsidian Atelier", city: "Paris, Fr", category: "Art Gallery", date: "Oct 24, 2026", status: "pending", image: "https://images.unsplash.com/photo-1518005020951-eccb494ad742?auto=format&fit=crop&w=200&q=80" },
  { id: 2, name: "Marble Peak Lounge", city: "Tulum, MX", category: "Private Lounge", date: "Oct 21, 2026", status: "validated", image: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=200&q=80" },
  { id: 3, name: "The Loft Project", city: "Brooklyn, NY", category: "Event Space", date: "Oct 18, 2026", status: "rejected", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=200&q=80" }
];
